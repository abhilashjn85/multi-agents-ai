...
class ResultsController:
    ...
    def get_results(self, experiment_id):
        ...
        result_path = os.path.join(self.output_folder, f"experiment_{experiment_id}", "results.json")
    ...
    def _ensure_visualization_files(self, experiment_id):
        ...
        self._generate_sample_confusion_matrix(os.path.join(vis_dir, "confusion_matrix.png"))
        ...
        self._generate_sample_feature_importance(os.path.join(vis_dir, "feature_importance.png"))
    ...
    def _generate_sample_pr_curve(self, output_path):
        ...
        plt.axhline(y=0.1, color='k', linestyle='--', alpha=0.5, label=f'Baseline (ratio = 0.1)')
        plt.xlabel('Recall')
